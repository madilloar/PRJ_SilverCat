...
public class PdfViewModel implements IModel {
    ...
    protected final RemoveEditPdfPageListHandler removeEditPdfPageListHandler = new RemoveEditPdfPageListHandler();
    ...
    private void redrawOriginalPdfPage(PdfFileModel model) {
        // ListModel#clear()をすると、at javax.swing.plaf.basic.BasicListUI.updateLayoutState(BasicListUI.java:1351)
    ...
    /**
     * PDFファイルを開く。
     * ファイルダイアログが表示されるので、Viewに持ち込むべきロジックかもしれない。 
     */
    protected class FileOpenHandler extends AbstractAction {
        public static final String KEY = "PDFファイルを開く";
    ...
    protected class SelectAllOriginalPdfPageListHandler extends AbstractAction {
        public static final String KEY = "↑全選択↑";
    ...
    protected class UnSelectAllOriginalPdfPageListHandler extends AbstractAction {
        public static final String KEY = "↑全選択解除↑";
    ...
    protected class AddEditPdfPageListHandler extends AbstractAction {
        public static final String KEY = "↓追加";
     ...
     */
    protected class RemoveEditPdfPageListHandler extends AbstractAction {
        public static final String KEY = "↑削除";

        public RemoveEditPdfPageListHandler() {
            putValue(Action.NAME, KEY);
        }
    ...
    protected class RotateEditPdfPageListHandler extends AbstractAction {
        public static final String KEY = "→90度回転";
    ...
    protected class CreatePdfHandler extends AbstractAction {
        public static final String KEY = "◎PDFファイル作成";
                    ...
                    try {
                        ...
                        newPdfFile.addModelListener(new IModelListener() {
                            public void modelChanged(ModelEvent event) {
                                ...
                                if (processPage >= pagesSize
                                        || model.getStatus()
                                                .equals(PdfFileModel.STATUS_CODE.CREATE_PDF_FILE_PROCESSEND)) {
