...
public class PdfPageModelTest {
  ...
  public void testRotate() {
    ...
    exp.rotate();
    act.rotate();
    byte[] bExp = this.convertBufferedImageToJpegByteArray(this.convertImageToBufferedImage(exp.getPdfPageImage().getImage()));
    byte[] bAct = this.convertBufferedImageToJpegByteArray(this.convertImageToBufferedImage(act.getPdfPageImage().getImage()));
